...
function Navbar() {
  ...
  <div className='max-w-screen-xl mx-auto flex justify-between items-center py-3 2xl:py-4 2xl:p-0 p-6'>
        ...
        <div className='flex flex-col items-center gap-2 cursor-pointer py-3 md:py-0 relative text-start' 
  ...
  <div className={`transition-all duration-300 overflow-y-scroll w-full flex justify-center ${isDropdownOpen ? 'max-h-[800px]' : 'max-h-0'} md:max-h-none`}>
    <div className="md:hidden w-full flex justify-center">
      <ServicesDropdown />
        ...
        <div className='cursor-pointer py-3 md:py-0 flex flex-row gap-2 justify-center'onClick={() => navigate('/servicesPage')}>Services
