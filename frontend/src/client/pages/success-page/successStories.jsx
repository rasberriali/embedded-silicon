    ...
    <div className='font-inter'>
        ...
        <div className="max-w-screen-xl mx-auto px-4 py-16 bg-white mt-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {successStoriesData.slice(1).map((story) => (
              <div key={story.id} className="bg-white rounded-xl shadow-md overflow-hidden flex flex-col h-full transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
                ...
                <div className="px-6 pb-6"onClick={() => navigate('/stories')}>
